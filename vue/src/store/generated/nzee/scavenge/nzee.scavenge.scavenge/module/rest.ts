...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/nzee/scavenge/scavenge/commit
   */
  queryCommitAll = (
    query?: {
    ...
    this.request<ScavengeQueryAllCommitResponse, RpcStatus>({
      path: `/nzee/scavenge/scavenge/commit`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/nzee/scavenge/scavenge/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<ScavengeQueryParamsResponse, RpcStatus>({
      path: `/nzee/scavenge/scavenge/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/nzee/scavenge/scavenge/scavenge
   */
  queryScavengeAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<ScavengeQueryAllScavengeResponse, RpcStatus>({
      path: `/nzee/scavenge/scavenge/scavenge`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
