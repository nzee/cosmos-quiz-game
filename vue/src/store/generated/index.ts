...
import NzeeScavengeNzeeScavengeScavenge from './nzee/scavenge/nzee.scavenge.scavenge'
...
export default { 
  ...
  NzeeScavengeNzeeScavengeScavenge: load(NzeeScavengeNzeeScavengeScavenge, 'nzee.scavenge.scavenge'),
